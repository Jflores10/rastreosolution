...
$.fn.myfunc = function (userPref) {
  ...
  this.defaultProperty = {
    ...
    speedPositionTxtWH  : 40,          /**speedo-meter current value cont*/
  ...
  speedBgPosY,
  speedoWH           = this.defaultProperty.edgeRadius,
    ...
    var tempStyleVar = [
      '<style>',
        ...
        '#' + this.parentElemId + ' .speedNobe div{',
          'width  :'+ this.defaultProperty.speedoNobeW/2 + 'px;',
          'left :'+ this.defaultProperty.speedoNobeL/2 + 'px;',
        '}',      
  ...
  this.createIndicators = function(){
    for(var i=0; i<=noOfDev; i++){
      ...
      if(i%this.defaultProperty.noOfSmallDiv == 0){
        ...
        tempDiv += '<div class="nob '+dangCls+'" style="left:'+induCatorLinesPosTop/2+'px;top:'+induCatorLinesPosLeft/2+'px;'+tempDegInd+'"></div>';
        ...
        tempDiv += '<div class="numb '+dangCls+'" style="left:'+ induCatorNumbPosTop/2 +'px;top:'+induCatorNumbPosLeft/2+'px;">'+ curIndVal +'</div>';
      }else{
        ...
        tempDiv += '<div class="nob '+dangCls+' midNob" style="left:'+induCatorLinesPosTop/2+'px;top:'+induCatorLinesPosLeft/2+'px;'+tempDegInd+'"></div>';
